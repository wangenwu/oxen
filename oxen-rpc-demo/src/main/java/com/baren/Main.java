...
//                    + " with body " + message.getBody().toString());
    ...
    private static void startServer() throws IOException {
        server = new AvroNettyServer(new SpecificResponder(Mail.class, new MailImpl()), new InetSocketAddress(65112));
    ...
    public static void main(String[] args) throws IOException {
        ...
        AvroNettyTransceiver client = new AvroNettyTransceiver(new InetSocketAddress(65112));
